...
class VendingMachine:
    ...
    'Here is your soda.'
    """
    def __init__(self, item, cost, stock=0):
        self.item = item
        self.cost = cost
        self.stock = stock
        self.balance=0

    def restock(self, stock_incr):
        self.stock+=stock_incr
        return 'Current {} stock: {}'.format(self.item, self.stock)

    def deposit(self, cash):
        if self.stock==0:
            return 'Machine is out of stock. Here is your ${}.'.format(cash)
        self.balance+=cash
    ...
    def vend(self):
        ...
        if self.balance < self.cost:
            return 'You must deposit ${} more.'.format(self.cost-self.balance)
        if self.balance == self.cost:
            str = 'Here is your {}.'.format(self.item)
        if self.balance > self.cost:
            str = 'Here is your {} and ${} change.'.format(self.item, self.balance-self.cost)
        self.balance=0
        self.stock-=1
        return str

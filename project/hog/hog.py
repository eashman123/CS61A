...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    dice_rolls=[]
    [dice_rolls.append(dice()) for _ in range(num_rolls)]
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    return max([int(num) for num in str(score)]) + 1
    # END PROBLEM 2
...
def both(f, g):
    ...
    """
    # BEGIN PROBLEM 6
    def use_functions(score0, score1):
        nonlocal f, g
        f = f(score0, score1)
        g = g(score0, score1)
        return both(f, g)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def highest(score0, score1):
        ...
        def print_result(who):
            if previous_high > 1:
                print(previous_high, 'points! That\'s the biggest gain yet for Player', who)
            else:
                print(previous_high, 'point! That\'s the biggest gain yet for Player', who)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_dice_rolls in range(10):
        value=dice_average(num_dice_rolls+1, dice)
        if value>max_value:
            max_rolls=num_dice_rolls+1
            max_value= value
    return max_rolls
    # END PROBLEM 9
